...
# Resolve paths relative to the installation root (script is in bin/)
...
testcov_call="testcov $testcov_data_model --test-suite "$BASE_DIR/$zipfile" $rel_path_c_file --output "./sikraken_output/$base_name/testcov" --reduction NONE --no-runexec --no-isolation --no-plots"
