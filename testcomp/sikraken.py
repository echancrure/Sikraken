...
class Tool(benchexec.tools.template.BaseTool2):
    ...
    def executable(self, tool_locator):
        return tool_locator.find_executable("sikraken.sh")
    ...
    #we are currently ignoring property files as we only support "coverage-branches.prp"
    #options come from the benchmark definition .xml file "The benchmark definition defines the categories that the tester is to be executed on, the parameters to be passed, and the resource limits."
