...
int main() {
    ...
    int hexLower = 0x1a;
    int hexUpper = 0x1A;
    unsigned int hexUnsigned = 0x1AU;
    long hexLong = 0x1AL;
    unsigned long hexULong = 0x1AUL;
    unsigned int hex32bit = 0xFFFFFFFF;
    unsigned long long hex64bit = 0xFFFFFFFFFFFFFFFF;
    int mask8bit = 0xFF;
    int mask16bit = 0xFFFF;
    unsigned int memoryAddr = 0x7FFF0000;
    unsigned int whiteColor = 0xFFFFFF;
    unsigned int greenColor = 0x00FF00;
